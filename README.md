...
- All Programs coded with research, using Visual Studio Code IDE, with knwoledge of Decimal, Binary, Octal, Hexadecimal Number Systems, and with Assembly, Python, C/C++ Programming Languages, and finally, with Eng# Boot
...
"Something New"<br>
Adamant/Ethereal</p>
Architecture, which are a huge part of Computer Science. 
