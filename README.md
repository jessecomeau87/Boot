...
- I want to create my own Computer and Cell Phone, called the Rectitude XPS870 Operating Core Construct, and the Rectitude Ethereal Construct. 

- They will have a Cpu called, Wise.

- An Instruction Set called, Keen.

- Somewhat of a Kernel called, Reason.

- An Operating Systems called, Guru. 

- A Host called, Eunoia. 

- Artificial Intelligence called, Zenith. 

- A Cloud called, Grit. 

- And also, a program called, Acute. 

- All based on a few patent of mine, like, [IAA(S/E)A(-O) (c) (r) ISMC Corp. 2023]. 

- "Reactor", "Rectitude Operating Core Construct", "Rectitude Ethereal Construct", "Wise", "Keen", "Reason", "Guru", "Zenith", "Grit", and "Acute", and patents, are all my ideas, and they are protected. 
...
- The Boot Process explains what happens when you turn your computer on. 
...
I'll be one step closer to designing the Recititude Constructs from Reactor.
